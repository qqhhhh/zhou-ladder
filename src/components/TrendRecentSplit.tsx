...
/**
 * Desktop: left chart / right recent. Mouse-enter sticky focus + rAF width tween.
 * Mobile: stacked, no hover anim. No pointer-drag divider.
 */
export function TrendRecentSplit({
  ...
  /** Accepted for API compat; unused (no enter fade). */
  rangeKey?: string;
}) {
  void _rangeKey;
